...
const EXPECTED_TYPES = {
  STUDY_TASKS_PROPS: {
    ...
    EXPORTED_COMPLETE_DATE: 'rollup',
    EXPORTED_DUE_DATE: 'rollup',
    EXPORTED_ASSIGNEE: 'rollup',
    EXPORTED_ASSIGNEE_GROUP: 'rollup',
    MATCH_CONFIDENCE: 'rollup',
    OVERDUE: 'formula',
    DURATION_BUSINESS_DAYS: 'formula',
    CONTRACT_END_FOR_ROLLUP: 'formula',
    CONTRACT_SIGNED_FOR_ROLLUP: 'formula',
    MISMATCH_TRIAGER: 'button',
  ...
  STUDIES_PROPS: {
    ...
    TOTAL_ARR: 'number',
    TCV: 'number',
    CURRENT_CONTRACT_TERM: 'formula',
    MIGRATED_STUDY: 'relation',
    CREATED_TIME: 'created_time',
...
const DB_DESCRIPTORS = [
  ...
  },
  {
    label: 'STUDIES_PROPS',
    dbId: STUDIES_DB_ID,
    expectedTitle: 'Studies Database',
