...
export async function run({
  ...
  for (const study of diagnoseReports) {
    for (const component of study.components) {
      ...
      // pick the wrong entry. Per-component scoping closes that race window
      // to the ~100ms gap between this capture and the actual postWebhook
      // call inside applyComponentReplay.
